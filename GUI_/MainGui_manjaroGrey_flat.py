    ...
    def setupUi(self, MainWindow):
        ...
        if openboxStatus:
            ...
            fifthPageWidgets = {
                ...
                "packagesChromiumPic": [self.packagesChromiumPic, 20, 10, 71, 71, "packagesChromiumPic", "/usr/share/turbulence/images/manjaro-grey-flat/packages/network/chromium.png"],
                "packagesChromiumCheck": [self.packagesChromiumCheck, 10, 80, 111, 31, "packagesChromiumCheck", None],
                "packagesDelugePic": [self.packagesDelugePic, 140, 10, 71, 71, "packagesDelugePic", "/usr/share/turbulence/images/manjaro-grey-flat/packages/network/deluge.png"],
                "packagesDelugeCheck": [self.packagesDelugeCheck, 130, 80, 111, 31, "packagesDelugeCheck", None],
                "packagesEkigaPic": [self.packagesEkigaPic, 270, 10, 71, 71, "packagesEkigaPic", "/usr/share/turbulence/images/manjaro-grey-flat/packages/network/ekiga.png"],
                "packagesEkigaCheck": [self.packagesEkigaCheck, 260, 80, 102, 31, "packagesEkigaCheck", None],
                "packagesFilezillaPic": [self.packagesFilezillaPic, 400, 10, 71, 71, "packagesFilezillaPic", "/usr/share/turbulence/images/manjaro-grey-flat/packages/network/filezilla.png"],
                "packagesFilezillaCheck": [self.packagesFilezillaCheck, 390, 80, 111, 31, "packagesFilezillaCheck", None],
                "packagesFirefoxPic": [self.packagesFirefoxPic, 520, 10, 71, 71, "packagesFirefoxPic", "/usr/share/turbulence/images/manjaro-grey-flat/packages/network/firefox.png"],
                "packagesFirefoxCheck": [self.packagesFirefoxCheck, 510, 80, 111, 31, "packagesFirefoxCheck", None],
                "packagesMidoriPic": [self.packagesMidoriPic, 640, 10, 71, 71, "packagesMidoriPic", "/usr/share/turbulence/images/manjaro-grey-flat/packages/network/midori.png"],
                "packagesMidoriCheck": [self.packagesMidoriCheck, 630, 80, 111, 31, "packagesMidoriCheck", None],
                "packagesOperaPic": [self.packagesOperaPic, 20, 110, 71, 71, "packagesOperaPic", "/usr/share/turbulence/images/manjaro-grey-flat/packages/network/opera.png"],
                "packagesOperaCheck": [self.packagesOperaCheck, 10, 180, 111, 31, "packagesOperaCheck", None],
                "packagesQbittorrentPic": [self.packagesQbittorrentPic, 140, 110, 71, 71, "packagesQbittorrentPic", "/usr/share/turbulence/images/manjaro-grey-flat/packages/network/qbittorrent.png"],
                "packagesQbittorrentCheck": [self.packagesQbittorrentCheck, 130, 180, 111, 31, "packagesQbittorrentCheck", None],
                "packagesThunderbirdPic": [self.packagesThunderbirdPic, 270, 110, 71, 71, "packagesThunderbirdPic", "/usr/share/turbulence/images/manjaro-grey-flat/packages/network/thunderbird.png"],
                "packagesThunderbirdCheck": [self.packagesThunderbirdCheck, 260, 180, 120, 31, "packagesThunderbirdCheck", None],
                "packagesTransmissionPic": [self.packagesTransmissionPic, 400, 110, 71, 71, "packagesTransmissionPic", "/usr/share/turbulence/images/manjaro-grey-flat/packages/network/transmission.png"],
                ...
                "packagesPintaPic": [self.packagesPintaPic, 520, 10, 71, 71, "packagesPintaPic", "/usr/share/turbulence/images/manjaro-grey-flat/packages/graphics/pinta.png"],
                "packagesPintaCheck": [self.packagesPintaCheck, 510, 80, 111, 31, "packagesPintaCheck", None],
                "packagesViewniorPic": [self.packagesViewniorPic, 640, 10, 71, 71, "packagesViewniorPic", "/usr/share/turbulence/images/manjaro-grey-flat/packages/graphics/viewnior.png"],
                ...
                "packagesOctopiPic": [self.packagesOctopiPic, 400, 10, 71, 71, "packagesOctopiPic", "/usr/share/turbulence/images/manjaro-grey-flat/packages/accessories/octopi.png"],
                "packagesOctopiCheck": [self.packagesOctopiCheck, 390, 80, 111, 31, "packagesOctopiCheck", None],
                "packagesPamacPic": [self.packagesPamacPic, 520, 10, 71, 71, "packagesPamacPic", "/usr/share/turbulence/images/manjaro-grey-flat/packages/accessories/pamac.png"],
                "packagesPamacCheck": [self.packagesPamacCheck, 510, 80, 111, 31, "packagesPamacCheck", None],
                "packagesPcmanfmPic": [self.packagesPcmanfmPic, 640, 10, 71, 71, "packagesPcmanfmPic", "/usr/share/turbulence/images/manjaro-grey-flat/packages/accessories/pcmanfm.png"],
                "packagesPcmanfmCheck": [self.packagesPcmanfmCheck, 630, 80, 111, 31, "packagesPcmanfmCheck", None],
                "packagesSpacefmPic": [self.packagesSpacefmPic, 20, 110, 71, 71, "packagesSpacefmPic", "/usr/share/turbulence/images/manjaro-grey-flat/packages/accessories/spacefm.png"],
                "packagesSpacefmCheck": [self.packagesSpacefmCheck, 10, 180, 111, 31, "packagesSpacefmCheck", None],
                "packagesTerminatorPic": [self.packagesTerminatorPic, 140, 110, 71, 71, "packagesTerminatorPic", "/usr/share/turbulence/images/manjaro-grey-flat/packages/accessories/terminator.png"],
                "packagesTerminatorCheck": [self.packagesTerminatorCheck, 130, 180, 111, 31, "packagesTerminatorCheck", None],
                "packagesThunarPic": [self.packagesThunarPic, 270, 110, 71, 71, "packagesThunarPic" , "/usr/share/turbulence/images/manjaro-grey-flat/packages/accessories/thunar.png"],
                ...
                "packagesLibreOfficeInstallerPic": [self.packagesLibreOfficeInstallerPic, 140, 10, 71, 71, "packagesLibreOfficeInstallerPic", "/usr/share/turbulence/images/manjaro-grey-flat/packages/extras/libreofficeinstaller.png"],
                ...
                "packagesMultimediaSupportPic": [self.packagesMultimediaSupportPic, 270, 10, 71, 71, "packagesMultimediaSupportPic" , "/usr/share/turbulence/images/manjaro-grey-flat/packages/extras/multimediasupport.png"],
                "packagesMultimediaSupportCheck": [self.packagesMultimediaSupportCheck, 260, 90, 111, 41, "packagesMultimediaSupportCheck", None],
                "packagesPrinterSupportPic": [self.packagesPrinterSupportPic, 400, 10, 71, 71, "packagesPrinterSupportPic" , "/usr/share/turbulence/images/manjaro-grey-flat/packages/extras/printersupport.png"],
            ...
            self.packagesChromiumPic.setToolTip("The open-source project behind Google Chrome, an \n" "attempt at creating a safer, faster, and more stable browser")
            self.packagesChromiumCheck.setText("Chomium")
            self.packagesDelugePic.setToolTip("A BitTorrent client with multiple user interfaces \n" "in a client/server model")
            self.packagesDelugeCheck.setText("Deluge")
            self.packagesEkigaPic.setToolTip("VOIP/Videoconferencing app with full SIP and H.323 support")
            self.packagesEkigaCheck.setText("Ekiga")
            self.packagesFilezillaPic.setToolTip("Fast and reliable FTP, FTPS and SFTP client")
            self.packagesFilezillaCheck.setText("Filezilla")
            self.packagesFirefoxPic.setToolTip("Standalone web browser from mozilla.org")
            self.packagesFirefoxCheck.setText("Firefox")
            self.packagesMidoriPic.setToolTip("Lightweight web browser (GTK2)")
            self.packagesMidoriCheck.setText("Midori")
            self.packagesOperaPic.setToolTip("Fast and secure web browser and Internet suite")
            self.packagesOperaCheck.setText("Opera")
            self.packagesQbittorrentPic.setToolTip("A bittorrent client written in C++ / Qt4 using the good \n" "libtorrent library")
            self.packagesQbittorrentCheck.setText("QBittorrent")
            self.packagesThunderbirdPic.setToolTip("Standalone Mail/News reader")
            self.packagesThunderbirdCheck.setText("Thunderbird")
            self.packagesTransmissionPic.setToolTip("Fast, easy, and free BitTorrent client")
            ...
            self.packagesAudaciousPic.setToolTip("Lightweight, advanced audio player focused on audio quality")
            self.packagesAudaciousCheck.setText("Audacious")
            self.packagesClemetinePic.setToolTip("A music player and library organizer")
            self.packagesClementineCheck.setText("Clementine")
            self.packagesDeadbeefPic.setToolTip("An audio player for GNU/Linux based on GTK2.")
            self.packagesDeadbeefCheck.setText("DeaDBeeF")
            self.packagesSmplayerPic.setToolTip("A complete front-end for MPlayer")
            self.packagesSmplayerCheck.setText("SMPlayer")
            self.packagesVlcPic.setToolTip("A multi-platform MPEG, VCD/DVD, and DivX player")
            ...
            self.packagesBlenderPic.setToolTip("A fully integrated 3D graphics creation suite")
            self.packagesBlenderCheck.setText("Blender")
            self.packagesEvincePic.setToolTip("Simply a document viewer")
            self.packagesEvinceCheck.setText("Evince")
            self.packagesGimpPic.setToolTip("GNU Image Manipulation Program")
            self.packagesGimpCheck.setText("Gimp")
            self.packagesGpicviewPic.setToolTip("Lightweight image viewer")
            self.packagesGpicviewCheck.setText("GPicView")
            self.packagesPintaPic.setToolTip("A drawing/editing program modeled after Paint.NET.")
            self.packagesPintaCheck.setText("Pinta")
            self.packagesViewniorPic.setToolTip("A simple, fast and elegant image viewer program")
            ...
            self.packagesGeanyPic.setToolTip("Fast and lightweight IDE")
            self.packagesGeanyCheck.setText("Geany")
            self.packagesHexchatPic.setToolTip("A popular and easy to use graphical IRC (chat) client")
            self.packagesHexchatCheck.setText("Hexchat")
            self.packagesLeafpadPic.setToolTip("A notepad clone for GTK+ 2.0")
            self.packagesLeafpadCheck.setText("Leafpad")
            self.packagesOctopiPic.setToolTip("A powerful Pacman frontend using Qt libs")
            self.packagesOctopiCheck.setText("Octopi")
            self.packagesPamacPic.setToolTip("A gtk3 frontend for pyalpm")
            self.packagesPamacCheck.setText("Pamac")
            self.packagesPcmanfmPic.setToolTip("An extremely fast and lightweight file manager")
            self.packagesPcmanfmCheck.setText("PCManFM")
            self.packagesSpacefmPic.setToolTip("Multi-panel tabbed file manager")
            self.packagesSpacefmCheck.setText("SpaceFM")
            self.packagesTerminatorPic.setToolTip("Terminal emulator that supports tabs and grids")
            self.packagesTerminatorCheck.setText("Terminator")
            self.packagesThunarPic.setToolTip("Modern file manager for Xfce")
            ...
            self.packagesAurSupportPic.setToolTip("Installs yaourt, and required dependencies to access the AUR")
            self.packagesAurSupportCheck.setText("Aur \nSupport")
            self.packagesLibreOfficeInstallerPic.setToolTip("GUI installer for LibreOffice")
            self.packagesLibreOfficeInstallerCheck.setText("Libre Office \nInstaller")
            self.packagesMultimediaSupportPic.setToolTip("Installs flashplugin, and required codecs for playing media")
            self.packagesMultimediaSupportCheck.setText("Multimedia \nSupport")
            self.packagesPrinterSupportPic.setToolTip("Installs manjaro-printer, and CUPS to enable printers")
        ...
        verifyPageWidgets = {
            ...
            "verifyIcon": [self.verifyIcon, 40, 160, 61, 61, "verifyIcon", "/usr/share/turbulence/images/manjaro-grey-flat/verify/verify.png"],
        ...
        verifyPageLayouts = {
            ...
            "verifyArrow": [self.verifyArrow, None, None, 21, 500, False, False, "/usr/share/turbulence/images/manjaro-grey-flat/menu-arrow.png"],
