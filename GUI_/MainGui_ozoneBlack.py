...
def createStaticWidgets(parent):
    ...
    staticWidgets = {
        "blackBackground": [blackBackground, -14, 73, 891, 551, "blackBackground", None],
        "headerBack": [headerBack, -20, 10, 921, 71, "headerBack", "/usr/share/turbulence/images/ozone-black/header.png"],
        "turbulenceLogo": [turbulenceLogo, 20, 20, 51, 51, "turbulenceLogo", "/usr/share/turbulence/images/ozone-black/turbulence.png"],
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        styleSheetFile = open("/usr/share/turbulence/stylesheets/ozoneblack.stylesheet", "r")
        ...
        MainWindow.setWindowIcon(QtGui.QIcon('/usr/share/turbulence/images/ozone-black/turbulence.png'))
        ...
        firstPageWidgets = {
            ...
            "arrow": [self.arrow, 130, 90, 111, 41, "arrow", "/usr/share/turbulence/images/ozone-black/arrow.png"],
            "folders2": [self.folders2, 160, 90, 81, 41, "folders2", None],
            ...
            "bullet1": [self.bullet1, 70, 365, 21, 21, "bullet1", "/usr/share/turbulence/images/ozone-black/bullet.png"],
            "bullet2": [self.bullet2, 70, 395, 21, 21, "bullet2", "/usr/share/turbulence/images/ozone-black/bullet.png"],
            "bullet3": [self.bullet3, 70, 425, 21, 21, "bullet3", "/usr/share/turbulence/images/ozone-black/bullet.png"],
            "bullet4": [self.bullet4, 70, 470, 21, 21, "bullet4", "/usr/share/turbulence/images/ozone-black/bullet.png"],
            "forward": [self.forward, 740, 580, 101, 23, "forward", None],
            "cancel": [self. cancel, 20, 580, 91, 23, "cancel", None],
        }
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(_fromUtf8("/usr/share/turbulence/images/ozone-black/arrow.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.forward.setIcon(icon1)
        self.forward.setIconSize(QtCore.QSize(28, 30))
        
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(_fromUtf8("/usr/share/turbulence/images/ozone-black/cancel.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        secondPageWidgets = {
            ...
            "arrow2": [self.arrow2, 110, 90, 31, 41, "arrow2", "/usr/share/turbulence/images/ozone-black/arrow.png"],
            "themes": [self.themes, 140, 90, 91, 41, "themes", None],
            "cancel2": [self.cancel2, 20, 580, 91, 23, "cancel2", None],
            "forward2": [self.forward2, 740, 580, 101, 23, "forward2", None],
            "previous": [self.previous, 630, 580, 101, 23, "previous", None],
            "folderIcon": [self.folderIcon, 40, 150, 61, 61, "folderIcon", "/usr/share/turbulence/images/ozone-black/foldericons/folder.png"],
            ...
            "folderIcon1": [self.folderIcon1, 60, 290, 81, 81, "folderIcon1", "/usr/share/turbulence/images/ozone-black/foldericons/desktop.png"],
            "folderIcon2": [self.folderIcon2, 60, 440, 81, 81, "folderIcon2", "/usr/share/turbulence/images/ozone-black/foldericons/pictures.png"],
            "folderIcon3": [self.folderIcon3, 270, 290, 81, 81, "folderIcon3", "/usr/share/turbulence/images/ozone-black/foldericons/documents.png"],
            "folderIcon4": [self.folderIcon4, 690, 290, 81, 81, "folderIcon4", "/usr/share/turbulence/images/ozone-black/foldericons/music.png"],
            "folderIcon5": [self.folderIcon5, 480, 290, 81, 81, "folderIcon5", "/usr/share/turbulence/images/ozone-black/foldericons/downloads.png"],
            "folderIcon6": [self.folderIcon6, 270, 440, 81, 81, "folderIcon6", "/usr/share/turbulence/images/ozone-black/foldericons/public.png"],
            "folderIcon7": [self.folderIcon7, 480, 440, 81, 81, "folderIcon7", "/usr/share/turbulence/images/ozone-black/foldericons/templates.png"],
            "folderIcon8": [self.folderIcon8, 690, 440, 81, 81, "folderIcon8", "/usr/share/turbulence/images/ozone-black/foldericons/videos.png"],
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(_fromUtf8("/usr/share/turbulence/images/ozone-black/arrowreverse.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        thirdPageWidgets = {
            ...
            "arrow3": [self.arrow3, 110, 90, 31, 41, "arrow3", "/usr/share/turbulence/images/ozone-black/arrow.png"],
            "menuWallpapers": [self.menuWallpapers, 140, 90, 111, 41, "menuWallpapers", None],
            "cancel3": [self.cancel3, 20, 580, 91, 23, "cancel3", None],
            "forward3": [self.forward3, 740, 580, 101, 23, "forward3", None],
            "previous2": [self.previous2, 630, 580, 101, 23, "previous2", None],
            "themeIcon": [self.themeIcon, 40, 160, 61, 61, "themeIcon", "/usr/share/turbulence/images/ozone-black/themes/theme.png"],
            ...
            "themePreview1": [self.themePreview1, 90, 280, 241, 81, "themePreview1", "/usr/share/turbulence/images/ozone-black/themes/ozone.png"],
            "themePreview2": [self.themePreview2, 510, 280, 241, 81, "themePreview2", "/usr/share/turbulence/images/ozone-black/themes/cupertino-ish.png"],
            "themePreview3": [self.themePreview3, 90, 410, 241, 81, "themePreview3", "/usr/share/turbulence/images/ozone-black/themes/oxygen.png"],
            "themePreview4": [self.themePreview4, 510, 410, 241, 81, "themePreview4", "/usr/share/turbulence/images/ozone-black/themes/plastik.png"],
        ...
        fourthPageWidgets = {
            ...
            "arrow4": [self.arrow4, 140, 90, 31, 41, "arrow4", "/usr/share/turbulence/images/ozone-black/arrow.png"],
            "menuFinish": [self.menuFinish, 170, 90, 71, 41, "menuFinish", None],
            "wallpaperIcon": [self.wallpaperIcon, 40, 160, 61, 61, "wallpaperIcon", "/usr/share/turbulence/images/ozone-black/wallpapers/wallpapers.png"],
            "wallpaperDesc": [self.wallpaperDesc, 110, 160, 591, 51, "wallpaperDesc", None],
            "previous3": [self.previous3, 630, 580, 101, 23, "previous3", None],
            "forward4": [self.forward4, 740, 580, 101, 23, "forward4", None],
            "cancel4": [self.cancel4, 20, 580, 91, 23, "cancel4", None],
            "wallpaperHeader": [self.wallpaperHeader, 50, 240, 121, 31, "wallpaperHeader", None],
            "wallpaper1": [self.wallpaper1, 40, 280, 141, 91, "wallpaper1", "/usr/share/turbulence/images/ozone-black/wallpapers/ozone.png"],
            "wallpaper2": [self.wallpaper2, 250, 280, 141, 91, "wallpaper2", "/usr/share/turbulence/images/ozone-black/wallpapers/orangesplash.png"],
            "wallpaper3": [self.wallpaper3, 470, 280, 141, 91, "wallpaper3", "/usr/share/turbulence/images/ozone-black/wallpapers/sunsetplane.png"],
            "wallpaper4": [self.wallpaper4, 680, 280, 141, 91, "wallpaper4", "/usr/share/turbulence/images/ozone-black/wallpapers/mountainlake.png"],
            "wallpaper5": [self.wallpaper5, 40, 410, 141, 91, "wallpaper5", "/usr/share/turbulence/images/ozone-black/wallpapers/earthinspace.png"],
            "wallpaper6": [self.wallpaper6, 250, 410, 141, 91, "wallpaper6", "/usr/share/turbulence/images/ozone-black/wallpapers/darkstairs.png"],
            "wallpaper7": [self.wallpaper7, 470, 410, 141, 91, "wallpaper7", "/usr/share/turbulence/images/ozone-black/wallpapers/cherryjapan.png"],
            "wallpaper8": [self.wallpaper8, 680, 410, 141, 91, "wallpaper8", "/usr/share/turbulence/images/ozone-black/wallpapers/whitetiger.png"],
        ...
        finalPageWidgets = {
            ...
            "arrow5": [self.arrow5, 130, 90, 31, 41, "arrow5", "/usr/share/turbulence/images/ozone-black/arrow.png"],
            "cancel5": [self.cancel5, 20, 580, 91, 23, "cancel5", None],
            "forward5": [self.forward5, 750, 580, 91, 23, "forward5", None],
            "previous4": [self.previous4, 640, 580, 101, 23, "previous4", None],
            ...
            "systemSettingsPic": [self.systemSettingsPic, 70, 260, 111, 101, "systemSettingsPic", "/usr/share/turbulence/images/ozone-black/finish/preferences-system.png"],
            ...
            "helpPic": [self.helpPic, 70, 440, 111, 101, "helpPic", "/usr/share/turbulence/images/ozone-black/finish/help-icon.png"],
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(_fromUtf8("/usr/share/turbulence/images/ozone-black/checkmark.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
