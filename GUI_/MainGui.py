...
def createStaticWidgets(parent):
    ...
    staticWidgets = {
        ...
        "headerBack": [headerBack, -20, 10, 921, 71, "headerBack", "/usr/share/turbulence/images/header.png"],
        "turbulenceLogo": [turbulenceLogo, 20, 20, 51, 51, "turbulenceLogo", "/usr/share/turbulence/images/turbulence.png"],
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setWindowIcon(QtGui.QIcon('/usr/share/turbulence/images/turbulence.png'))
        ...
        firstPageWidgets = {
            ...
            "arrow": [self.arrow, 130, 90, 111, 41, "arrow", "/usr/share/turbulence/images/arrow.png"],
            ...
            "bullet1": [self.bullet1, 70, 365, 21, 21, "bullet1", "/usr/share/turbulence/images/bullet.png"],
            "bullet2": [self.bullet2, 70, 395, 21, 21, "bullet2", "/usr/share/turbulence/images/bullet.png"],
            "bullet3": [self.bullet3, 70, 425, 21, 21, "bullet3", "/usr/share/turbulence/images/bullet.png"],
            "bullet4": [self.bullet4, 70, 470, 21, 21, "bullet4", "/usr/share/turbulence/images/bullet.png"],
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(_fromUtf8("/usr/share/turbulence/images/arrow.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.forward.setIcon(icon1)
        self.forward.setIconSize(QtCore.QSize(28, 30))
        
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(_fromUtf8("/usr/share/turbulence/images/cancel.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        secondPageWidgets = {
            ...
            "arrow2": [self.arrow2, 110, 90, 31, 41, "arrow2", "/usr/share/turbulence/images/arrow.png"],
            ...
            "folderIcon": [self.folderIcon, 40, 150, 61, 61, "folderIcon", "/usr/share/turbulence/images/foldericons/folder.png"],
            ...
            "folderIcon1": [self.folderIcon1, 60, 290, 81, 81, "folderIcon1", "/usr/share/turbulence/images/foldericons/desktop.png"],
            "folderIcon2": [self.folderIcon2, 60, 440, 81, 81, "folderIcon2", "/usr/share/turbulence/images/foldericons/pictures.png"],
            "folderIcon3": [self.folderIcon3, 270, 290, 81, 81, "folderIcon3", "/usr/share/turbulence/images/foldericons/documents.png"],
            "folderIcon4": [self.folderIcon4, 690, 290, 81, 81, "folderIcon4", "/usr/share/turbulence/images/foldericons/music.png"],
            "folderIcon5": [self.folderIcon5, 480, 290, 81, 81, "folderIcon5", "/usr/share/turbulence/images/foldericons/downloads.png"],
            "folderIcon6": [self.folderIcon6, 270, 440, 81, 81, "folderIcon6", "/usr/share/turbulence/images/foldericons/public.png"],
            "folderIcon7": [self.folderIcon7, 480, 440, 81, 81, "folderIcon7", "/usr/share/turbulence/images/foldericons/templates.png"],
            "folderIcon8": [self.folderIcon8, 690, 440, 81, 81, "folderIcon8", "/usr/share/turbulence/images/foldericons/videos.png"],
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(_fromUtf8("/usr/share/turbulence/images/arrowreverse.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        thirdPageWidgets = {
            ...
            "arrow3": [self.arrow3, 110, 90, 31, 41, "arrow3", "/usr/share/turbulence/images/arrow.png"],
            ...
            "themeIcon": [self.themeIcon, 40, 160, 61, 61, "themeIcon", "/usr/share/turbulence/images/themes/theme.png"],
            ...
            "themePreview1": [self.themePreview1, 90, 280, 241, 81, "themePreview1", "/usr/share/turbulence/images/themes/ozone.png"],
            "themePreview2": [self.themePreview2, 510, 280, 241, 81, "themePreview2", "/usr/share/turbulence/images/themes/laptop.png"],
            "themePreview3": [self.themePreview3, 90, 410, 241, 81, "themePreview3", "/usr/share/turbulence/images/themes/oxygen.png"],
            "themePreview4": [self.themePreview4, 510, 410, 241, 81, "themePreview4", "/usr/share/turbulence/images/themes/plastik.png"],
        ...
        fourthPageWidgets = {
            ...
            "arrow4": [self.arrow4, 140, 90, 31, 41, "arrow4", "/usr/share/turbulence/images/arrow.png"],
            "menuFinish": [self.menuFinish, 170, 90, 71, 41, "menuFinish", None],
            "wallpaperIcon": [self.wallpaperIcon, 40, 160, 61, 61, "wallpaperIcon", "/usr/share/turbulence/images/wallpapers/wallpapers.png"],
            ...
            "wallpaper1": [self.wallpaper1, 40, 280, 141, 91, "wallpaper1", "/usr/share/turbulence/images/wallpapers/ozone.png"],
            "wallpaper2": [self.wallpaper2, 250, 280, 141, 91, "wallpaper2", "/usr/share/turbulence/images/wallpapers/orangesplash.png"],
            "wallpaper3": [self.wallpaper3, 470, 280, 141, 91, "wallpaper3", "/usr/share/turbulence/images/wallpapers/sunsetplane.png"],
            "wallpaper4": [self.wallpaper4, 680, 280, 141, 91, "wallpaper4", "/usr/share/turbulence/images/wallpapers/mountainlake.png"],
            "wallpaper5": [self.wallpaper5, 40, 410, 141, 91, "wallpaper5", "/usr/share/turbulence/images/wallpapers/earthinspace.png"],
            "wallpaper6": [self.wallpaper6, 250, 410, 141, 91, "wallpaper6", "/usr/share/turbulence/images/wallpapers/darkstairs.png"],
            "wallpaper7": [self.wallpaper7, 470, 410, 141, 91, "wallpaper7", "/usr/share/turbulence/images/wallpapers/cherryjapan.png"],
            "wallpaper8": [self.wallpaper8, 680, 410, 141, 91, "wallpaper8", "/usr/share/turbulence/images/wallpapers/whitetiger.png"],
        ...
        finalPageWidgets = {
            ...
            "arrow5": [self.arrow5, 130, 90, 31, 41, "arrow5", "/usr/share/turbulence/images/arrow.png"],
            ...
            "systemSettingsPic": [self.systemSettingsPic, 70, 260, 111, 101, "systemSettingsPic", "/usr/share/turbulence/images/finish/preferences-system.png"],
            ...
            "helpPic": [self.helpPic, 70, 440, 111, 101, "helpPic", "/usr/share/turbulence/images/finish/help-icon.png"],
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(_fromUtf8("/usr/share/turbulence/images/checkmark.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
